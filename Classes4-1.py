import matplotlib.py as plt #Matplotlib bliver importeret for at kunne visualisere de grafer der bliver dannet af dataen der bliver indsamlet under Session.
